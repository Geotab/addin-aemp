...
geotab.addin.aEMPFormat = function () {
 ...
 function startXML(){
    var eqpXML = '<Fleet></Fleet>'//'<Equipment><EquipmentHeader><UnitInstallDateTime>default</UnitInstallDateTime><Make>default</Make><Model>default</Model><EquipmentID>default</EquipmentID><SerialNumber>default</SerialNumber></EquipmentHeader><Location datetime="2019-06-05"><Latitude>default</Latitude><Longitude>default</Longitude><Altitude><AltitudeUnits>default</AltitudeUnits><Meters>default</Meters></Altitude></Location><CumulativeOperatingHours datetime="2019-06-05"><Hour>default</Hour><ResetDateTime>default</ResetDateTime></CumulativeOperatingHours><FuelUsed datetime="2019-06-05"><FuelUnits>default</FuelUnits><FuelConsumed>default</FuelConsumed></FuelUsed><FuelUsedLast24 datetime="2019-06-05"><FuelUnits>default</FuelUnits><FuelConsumed>default</FuelConsumed></FuelUsedLast24><Distance datetime="2019-06-05"><OdometerUnits>default</OdometerUnits><Odometer>default</Odometer><ResetDateTime>default</ResetDateTime></Distance></Equipment>' 
  ...
  var ind,
    ...
    if (headerInfo[1][0].deviceType == 'CustomVehicleDevice'){
      ...
      if (!(vehicleInfo[15].length == 0 || vehicleInfo[18] == 0)){
        ...
        xmlNode(xmlDoc, 'EngineNumber', engineNumber, 'EngineStatus', elCount[11]) //fix this
